...
const AppPage = ({ params: { appName } }: { params: { appName: string } }) => {
            ...
            <div>
                ...
                <ul>
                    ...
                    <p className={pStyles}>
                        ...
                        {name}. By accessing or using {name}, you agree to be
                        bound by these terms and conditions.
                    </p>
                    <p className={pStyles}>
                        {name} (&ldquo;we,&rdquo; &ldquo;our,&rdquo;
                        &ldquo;us&rdquo;) provides this Terms of Use Agreement
                        (&ldquo;Agreement&rdquo;) to govern your use of {name}{' '}
                        and its related services. By accessing or using {name},
                        you agree to comply with and be bound by this Agreement,
                        as well as any other terms, guidelines, or rules that we
                        may post.
                    </p>
                    <p className={pStyles}>
                        By using {name}, you accept and agree to be bound by
                        these Terms of Use. If you do not agree to these terms,
                        please do not use {name}.
                    </p>
                    <p className={pStyles}>
                        We may modify these Terms of Use at any time. You are
                        responsible for regularly reviewing these terms, and
                        your continued use of {name} constitutes your acceptance
                        of any changes.
                    </p>
                    <p className={pStyles}>
                        We reserve the right to terminate or suspend access to{' '}
                        {name} at our discretion without notice, including for
                    ...
                    <p className={pStyles}>
                        ...
                        {name} is designed to respect your privacy, and we do
                ...
                <p className={pStyles}>
                    ...
                    personal information, please contact us at {email}.
                </p>
